...
export default function DMList() {
  ...
  const [resolveSchema, setResolveSchema] = React.useState({})
            ...
            {rows.length > 0 ? rows.map((row,index) => {
              return (
                <TableRow key={index}>
                  ...
                  <TableCell align="center">{row.fieldschema.title ? row.fieldschema.title :row.fieldschema.nodeType}</TableCell>
                  <TableCell align="center">
                    <Link color="inherit" href={"/datamodelpreview/" + index}>
                      <IconButton
                        aria-label="preview"
                        color="primary"
              ...
              <div>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setResolveSchema(resolveRef(JSON.parse(editorRef.current.getValue())))
                  }}
                >
                  apply
                </Button>
